...
import art.artifact_batch.Config.Enums.JobType;
...
public  class DefaultJob <R, W>{
   ...
   public Job newJob(
    ...
    private Step getStep() {
       ...
       if(batchProperties.getJobType().equals(JobType.ASYNC_PROCESSING)){
    ...
    private Step build() {
        ...
        if (batchProperties.getJobType().equals(JobType.MULTI_THREADED_STEP)) builder.taskExecutor(this.configuredTaskExecutor);
